...
// The flow-2↔3 diff toggle: the PRIMARY gesture. Flip PKCE and the two runs stay
// identical until they diverge at one highlighted step. Driven entirely by
// CompareResponse.divergences, so it is a pure function of the trace.
export function CompareBar({ compare, side, onSetSide, currentSeq }: Props) {
  ...
  return (
    <section className="compare" aria-label="PKCE comparison">
      ...
      <div className="toggle" role="radiogroup" aria-labelledby="pkce-toggle-label">
        <button
